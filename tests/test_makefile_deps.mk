...
tests/cases/address/addressmod_wrapper.c: tests/cases/address/address.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/address/address.c -o $@
...
tests/cases/array_sig/arraymod_wrapper.c: tests/cases/array_sig/array_sig.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/array_sig/array_sig.c -o $@
...
tests/cases/constants/constmod_wrapper.c: tests/cases/constants/constants.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/constants/constants.c -o $@
...
tests/cases/docstring/docmod_wrapper.c: tests/cases/docstring/docstring.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/docstring/docstring.c -o $@
...
tests/cases/dot/dotmod_wrapper.c: tests/cases/dot/dot.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/dot/dot.c -o $@
...
tests/cases/freethreading/freethreadmod_wrapper.c: tests/cases/freethreading/freethread.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/freethreading/freethread.c -o $@
...
tests/cases/gil_release/gilmod_wrapper.c: tests/cases/gil_release/sleep_fill.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/gil_release/sleep_fill.c -o $@
...
tests/cases/optional/optmod_wrapper.c: tests/cases/optional/optional.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/optional/optional.c -o $@
...
tests/cases/scalar_output/statmod_wrapper.c: tests/cases/scalar_output/stats.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/scalar_output/stats.c -o $@
...
tests/cases/simd_dispatch/simd_fillmod_wrapper.c: tests/cases/simd_dispatch/simd_fill.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/simd_dispatch/simd_fill.c -o $@
...
tests/cases/template/summod_wrapper.c: tests/cases/template/template.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/template/template.c -o $@
...
tests/cases/timing/timedmod_wrapper.c: tests/cases/timing/timing.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/timing/timing.c -o $@
...
tests/cases/transform/xfrm_wrapper.c: tests/cases/transform/transform.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/transform/transform.c -o $@
...
tests/cases/typedispatch/dispatchmod_wrapper.c: tests/cases/typedispatch/typedispatch.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/typedispatch/typedispatch.c -o $@
...
tests/cases/types/typesmod_wrapper.c: tests/cases/types/types.c $(RUNTIME_HDRS)
	python3 -m c2py23 tests/cases/types/types.c -o $@
