...
#
# To regenerate:  python tools/generate_makefile_deps.py > tests/test_makefile_deps.mk
#
# Each module has two rules:
#   1. _wrapper.c  <-  .c2py + runtime headers  (generate step)
#   2. .so/.pyd    <-  _wrapper.c + user .c + runtime.c  (compile)
